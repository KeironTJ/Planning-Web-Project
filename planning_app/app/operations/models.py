...
class WorksOrder(db.Model):
    ...
    leg_mtl       = db.Column(db.Text, nullable=True)
    castor_mtl    = db.Column(db.Text, nullable=True)
    castor_desc   = db.Column(db.Text, nullable=True)
    stud1_mtl     = db.Column(db.Text, nullable=True)
    stud2_mtl     = db.Column(db.Text, nullable=True)
    seat_interior_mtl = db.Column(db.Text, nullable=True)
    back_interior_mtl = db.Column(db.Text, nullable=True)
    scat_interior_mtl = db.Column(db.Text, nullable=True)
    material_1 = db.Column(db.Text, nullable=True)
