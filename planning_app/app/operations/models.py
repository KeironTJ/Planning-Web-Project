...
class WorksOrder(db.Model):
    ...
    so_type_desc     = db.Column(db.Text,        nullable=True)
    ...
    size_desc     = db.Column(db.Text, nullable=True)
    prod_size     = db.Column(db.Text, nullable=True)
    cover         = db.Column(db.String(100), nullable=True)
    cover_type    = db.Column(db.Text,        nullable=True)
    leg           = db.Column(db.Text,        nullable=True)
    leg_mtl       = db.Column(db.String(100), nullable=True)
    castor_mtl    = db.Column(db.String(100), nullable=True)
    castor_desc   = db.Column(db.Text,        nullable=True)
    stud1_mtl     = db.Column(db.String(100), nullable=True)
    stud2_mtl     = db.Column(db.String(100), nullable=True)
    seat_interior_mtl = db.Column(db.String(100), nullable=True)
    back_interior_mtl = db.Column(db.String(100), nullable=True)
    scat_interior_mtl = db.Column(db.String(100), nullable=True)
    material_1 = db.Column(db.String(100), nullable=True)
    material_1_desc = db.Column(db.Text, nullable=True)
...
class ProductionOutput(db.Model):
    ...
    line_desc     = db.Column(db.Text, nullable=True)
